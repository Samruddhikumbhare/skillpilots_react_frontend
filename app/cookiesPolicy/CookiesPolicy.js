    ...
    <div className="usefulLinkData">
      ...
      <ul>
        <li>
          ...
          this Cookies Policy) refers to Cluematrix Technology Pvt. Ltd, Plot
          No. 25, Vaishnavi Nagar, Vikasanand Mission Co, opp Society, Kharbi,
        ...
        <li>
          <strong>Website</strong> refers to SkillPilots, accessible from{" "}
          <a
            href="https://www.skillpilots.com/"
            rel="external nofollow noopener"
            target="_blank"
          >
            https://www.skillpilots.com/
          </a>
        </li>
        <li>
      ...
      <ul>
        <li>By email: support@cluematrix.com</li>
      </ul>
    </div>
  );
}
